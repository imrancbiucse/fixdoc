...
$sql = "SELECT * FROM add_assistant WHERE id = $id";
...
<body style="background-color:silver">
  ...
  <div class="row">
    ...
    <div class="col-sm-8" style="background-color:white";><br><br>
      ...
      <div>
          <h1 class="display-5 text-center my-4">Update Assistant</h1>
              <div class="container">
                  <form action="update_assistant.php? id=<?php echo $id ?>" method="POST">
                      <div class="form-group">
                        <label for="assistant_name"><b>Assistant Full Name:</b></label>
                        <input class="form-control" type="text" placeholder="Enter Assistant Name" name="assistant_name" value="<?php echo $ass['assistant_name']?>" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Enter Mobile Number" name="mobile" value="<?php echo $ass['mobile']?>">
                      </div>

                      <div class="form-group">
                        <label for="assigned_password"><b>Assigned Password:</b></label>
                        <input class="form-control" type="text" placeholder="Enter Password" name="password" required value="<?php echo $ass['assigned_password']?>">
                      </div>

                      <div class="form-group">
                        <label for="address"><b>Address:</b></label>
                        <input class="form-control" type="text" name="address" value="<?php echo $ass['address']?>">
                      </div>

                      <div class="form-group">
                      <label for="file"><b>Upload Id</b>(Passport/NID/Driving License):</label>
                      <div class="custom-file">
                          <input type="file" name="upload" class="custom-file-input" id="inputGroupFile01" value="<?php echo $ass['upload_id']?>">
